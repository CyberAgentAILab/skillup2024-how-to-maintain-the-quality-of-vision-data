...
# 自己紹介
##
<img src="/src/0000_20250313132438.png" style="width: 90%; display: block; margin: auto;" />
...
<img src="/src/0023_mAP.png" style="width: 67%; display: block; margin: auto;" />
...
##
![1](/src/0004_000000000692.jpg)
![2](/src/0005_000000000692.jpg)
...
##
![3](/src/0006_000000000544.jpg)
![4](/src/0007_000000000544.jpg)
...
![5](/src/0008_000000000692.jpg)

::right::

&nbsp;{.large-text}
##
![6](/src/0009_image.png)
...
##
画質の比較ではない{.large-text}
![7](/src/0010_000000000544.jpg)

::right::

&nbsp;{.large-text}
##
![8](/src/0011_image.jpg)
...
<div class="content">
  <div class="row">
    <div class="ml-auto">
      <ul>
        対象とカメラの角度（俯角最大）
        <img src="/src/0013_upper.png" />
      </ul>
      <ul>
        ノイズ（コントラスト破壊）
        <img src="/src/0014_brightness.png" />
      </ul>
    </div>
    <div class="ml-0">
      <ul>
        故意のアスペクト比破壊（427ｘ640 -> 480x360）
        <img src="/src/0015_aspectratio.png" />
      </ul>
      <ul>
        ノイズ（モーションブラー）＋ 対象のサイズが極小
        <img src="/src/0016_blur.png" />
      </ul>
    </div>
  </div>
</div>
...
<div class="content">
  <div class="row">
    <div class="ml-auto">
      <ul>
        <img src="/src/0018_normal.png" />
      </ul>
    </div>
    <div class="ml-0">
      <ul>
        <img src="/src/0019_up___.png" />
      </ul>
    </div>
  </div>
</div>
...
<img src="/src/0020_kuma.jpg" style="width: 43%; display: block; margin: auto;" />
...
&nbsp;
<img src="/src/0024_class_hierarchy.png" style="width: 100%; display: block; margin: auto;" />&nbsp;<img src="/src/0024_000000000693.jpg" style="width: 65%; display: block; margin: auto;" />
...
<video controls>
  <source src="/src/0001_annotation.mp4" type="video/mp4">
</video>
...
- アーキテクチャは重要{.large-text}
- パイプラインは重要{.large-text}
